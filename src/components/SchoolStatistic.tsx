...
export default function SchoolStatistic({ isOpen, onClose, data, isLoading }: SchoolStatisticProps) {
    ...
    >
      <div className="p-6 space-y-6">
        ...
        <div>
          ...
          <p className="text-neutral-800 text-lg mt-1">Kecamatan Medan Denai</p>
        </div>

        {/* School Statistics */}
        <div className="space-y-4">
          <h2 className="text-sm font-medium text-neutral-500">Statistik Sekolah</h2>
          ...
          <div className="grid gap-3">
            ...
            <div className="bg-neutral-50 rounded-lg p-3 border border-neutral-200">
              <div className="text-xs text-neutral-500">Sekolah Menengah Pertama (SMP)</div>
              <div className="text-2xl font-bold text-emerald-600 mt-1">{schoolCounts.SMP}</div>
            </div>
            
            <div className="bg-neutral-50 rounded-lg p-3 border border-neutral-200">
              <div className="text-xs text-neutral-500">Sekolah Menengah Atas (SMA)</div>
              <div className="text-2xl font-bold text-purple-600 mt-1">{schoolCounts.SMA}</div>
            </div>
